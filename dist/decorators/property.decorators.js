...
function ApiUUIDProperty(options = {}) {
    return (0, swagger_1.ApiProperty)(Object.assign({ type: (options === null || options === void 0 ? void 0 : options.each) ? [String] : String, format: 'uuid', isArray: options === null || options === void 0 ? void 0 : options.each }, options));
}
